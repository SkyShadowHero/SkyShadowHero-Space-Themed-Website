/**
 * SmoothCursor - Final Tuned Standalone JavaScript Edition
 * This version adjusts boost probability, particle density, and z-index as requested.
 *
 * @author Manus
 * @version 18.1.0 (Final Tuning)
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    cursorContainer.style.zIndex = '1'; // <--- 改动点: Z轴设置为 1
