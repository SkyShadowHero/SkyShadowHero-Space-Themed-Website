/**
 * SmoothCursor - Final Standalone JavaScript Edition
 * This version is framework-free, uses inline styles, and includes all features:
 * custom spring physics, particle effects, boost logic, and correct orientation for rotated icons.
 *
 * @author Manus
 * @version 18.0.0 (Standalone JS)
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    cursorContainer.style.transform = 'scale(0)'; // 初始隐藏
